...
const dictionary = {
  en: {
    ...
    'login.google.error': 'Google sign-in failed. Please try again.',
    'login.google.unconfigured': 'Google login is not configured.',
  ...
  vi: {
    ...
    'login.google.or': 'hoặc',
    'login.google.button': 'Tiếp tục với Google',
    'login.google.error': 'Đăng nhập Google thất bại. Vui lòng thử lại.',
    'login.google.unconfigured': 'Đăng nhập Google chưa được cấu hình.',
